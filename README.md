...
В разметке расставлены комментарии `<!-- TODO: заменить -->`. Их четыре:

1. **Уведомления на первом экране** — имена, время и суммы вымышленные. Когда появятся реальные
   заявки, перепишите три карточки на настоящие (без фамилий и телефонов).
2. **Факт «7 дней»** в полосе с цифрами. Два других факта настоящие, они из проекта «ШинаПро».
3. **Цены и сроки услуг** — стартовые планки проставлены на глаз.
4. **Три отзыва** — тексты вымышленные, замените после первых проектов.
